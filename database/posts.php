...
$posts = [
  [
    ...
    'tags' =>  ['pogramação', 'php', 'lógica de programação'],
  ...
  [
    ...
    'tags' =>  ['javascript', 'algoritmos', 'lógica de programação'],
    'image' => 'https://picsum.photos/500/500'
  ],
  [
    "id" => 9,
  ...
  [
    ...
    'tags' =>  ['wordpress', 'php', 'lógica de programação'],
    'image' => 'https://picsum.photos/500/500'
  ],
  [
    "id" => 12,
  ...
  [
    ...
    'tags' =>  ['tailwindcss', 'sacc', 'css-in-js'],
    'image' => 'https://picsum.photos/500/500'
  ],
  [
    "id" => 14,
    ...
    'tags' =>  ['styled-components', 'bootstrap', 'block element modifier - BEM'],
    'image' => 'https://picsum.photos/500/500'
  ],
];
